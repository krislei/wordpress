...
Description: 高级可视化编辑器插件。更多汉化主题、主题升级、问题咨询请访问：<strong><a href="http://www.4mudi.com">http://www.4mudi.com</a></strong>或者光临<a href="http://wordpresszhuti.taobao.com">四亩地淘宝店</a>
Version: 5.0.1
Author: 四亩地
...
class Vc_Manager {
	...
	public function pluginsLoaded() {
		...
		load_plugin_textdomain( 'js_composer', false, $this->path( 'APP_DIR', 'locale1345' ) );
	}
