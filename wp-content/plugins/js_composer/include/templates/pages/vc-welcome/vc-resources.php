...
<div class="vc_resources-tab changelog">
	<div class="feature-section vc_row">
		<div class="vc_col-xs-6">
			...
			<ul>
				<li>
					<a href="http://www.4mudi.com"
					   target="_blank">官方网站</a></li>
				<li><a href="http://wordpresszhuti.taobao.com" target="_blank">四亩地淘宝店</a></li>
				<li><a href="http://kb.wpbakery.com" target="_blank">官方知识库</a></li>
				<li><a href="http://vc.wpbakery.com/video-academy/" target="_blank">视频学院</a></li>
				<li><a href="http://support.wpbakery.com" target="_blank">官方支持</a></li>
				<li><a href="http://facebook.com/wpbakery" target="_blank">Facebook页面</a></li>
				<li><a href="http://twitter.com/wpbakery" target="_blank">Twitter帐户</a></li>
			</ul>
		</div>
