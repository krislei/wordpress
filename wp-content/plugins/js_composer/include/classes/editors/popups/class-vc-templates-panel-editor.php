			...
			if ( vc_user_access()->part( 'templates' )->checkStateAny( true, null )->get() ) {
				...
				<div class="vc_column vc_col-sm-12" data-vc-hide-on-search="true">
					...
					<div class="vc_input-group">
						<input name="padding" data-js-element="vc-templates-input" class="vc_form-control wpb-textinput vc_panel-templates-name" type="text" value="" placeholder="' . esc_attr( '模板名', 'js_composer' ) . '" data-vc-disable-empty="#vc_ui-save-template-btn">
