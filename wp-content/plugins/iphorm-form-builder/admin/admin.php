    ...
    if (isset($_GET['page'])) {
        if ($_GET['page'] === 'iphorm_form_builder') {
            ...
            wp_localize_script('iphorm-admin', 'iphormAdminL10n', array(
                'single_delete_message' => __('w---p---l---o---c---k---e---r - Are you sure you want to delete this form? All saved settings, elements and entries for this form will be lost and this cannot be undone.', 'iphorm'),
...
function iphorm_admin_l10n()
{
    $data = array(
        ...
        'unsaved_changes' => __('You have unsaved changes. W---P---L---0--C---K--3---R---.---C--0---M', 'iphorm'),
