...
function et_gf_enqueue_fonts( $et_gf_font_names ) {
	...
	foreach ( $et_gf_font_names as $et_gf_font_name ) {
		...
		if($et_gf_font_name_slug=='microsoft-yahei'||$et_gf_font_name_slug=='simsun'||$et_gf_font_name_slug=='simhei'||$et_gf_font_name_slug=='fangsong'||$et_gf_font_name_slug=='kaiti'){
			echo '';
		}else{
		wp_enqueue_style( 'et-gf-' . $et_gf_font_name_slug, esc_url( add_query_arg( $query_args, "http://fonts.googleapis.com/css" ) ), array(), null );
		}
	}
}
endif;