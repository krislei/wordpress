...
$options = array (
	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => __( "显示新浪微博图标", $themename ),
                   "id" => $shortname."_show_weibo_icon",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => __( "这里您可以开启新浪微博图标. ", $themename ) ),

			array( "name" => __( "显示腾讯微博图标", $themename ),
                   "id" => $shortname."_show_tqq_icon",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => __( "这里您可以开启腾讯微博图标. ", $themename ) ),

			array( "type" => "clearfix",),

			array( "name" => __( "显示人人网图标", $themename ),
                   "id" => $shortname."_show_renren_icon",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => __( "这里您可以开启人人网图标. ", $themename ) ),

			array( "name" => __( "显示微信图标", $themename ),
                   "id" => $shortname."_show_weixin_icon",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => __( "这里您可以开启微信图标. ", $themename ) ),
			...
			array( "name" => __( "新浪微博链接地址", $themename ),
                   "id" => $shortname."_weibo_url",
                   "std" => "#",
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => __( "输入新浪微博链接地址. ", $themename ) ),

            array( "name" => __( "腾讯微博链接地址", $themename ),
                   "id" => $shortname."_tqq_url",
                   "std" => "#",
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => __( "输入腾讯微博链接地址. ", $themename ) ),
			
			array( "name" => __( "人人网链接地址", $themename ),
                   "id" => $shortname."_renren_url",
                   "std" => "#",
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => __( "输入人人网链接地址. ", $themename ) ),
		   
		   array( "name" => __( "微信二维码链接地址", $themename ),
                   "id" => $shortname."_weixin_url",
                   "std" => "#",
                   "type" => "text",
                   "validation_type" => "url",
				   "desc" => __( "输入微信二维码链接地址. ", $themename ) ),
			...
			array( "name" => esc_html__("Posts limit",$themename),
				   "id" => $shortname."_limit_posts",
				   "std" => "135",
				   "type" => "text",
				   "desc" => esc_html__("Here you can set excerpt words limit.",$themename),
				   "validation_type" => "number"
			),
