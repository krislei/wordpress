(function($){
	...
	ET_Google_Fonts.prototype = {
		...
		maybe_request_font: function( font_name, font_option ) {
			...
			$head.append( '<link id="' + this.fontname_to_class( font_name ) + '" href="http://fonts.googleapis.com/css?family=' + this.convert_to_google_font_name( font_name ) + font_styles + subset + '" rel="stylesheet" type="text/css" />' );
		},
