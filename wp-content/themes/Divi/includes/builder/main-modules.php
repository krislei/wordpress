...
class ET_Builder_Module_Team_Member extends ET_Builder_Module {
	...
	function get_fields() {
		$fields = array(
			...
			'weibo_url' => array(
				'label'           => __( '新浪微博链接地址', 'et_builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => __( '输入新浪微博链接地址.', 'et_builder' ),
			),
			'tqq_url' => array(
				'label'           => __( '腾讯微博链接地址', 'et_builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => __( '输入腾讯微博链接地址.', 'et_builder' ),
			),
			'renren_url' => array(
				'label'           => __( '人人网链接地址', 'et_builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => __( '输入人人网链接地址.', 'et_builder' ),
			),
			'weixin_url' => array(
				'label'           => __( '微信二维码链接地址', 'et_builder' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => __( '输入微信二维码链接地址.', 'et_builder' ),
			),
			'facebook_url' => array(
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$image_url         = $this->shortcode_atts['image_url'];
		$animation         = $this->shortcode_atts['animation'];
		$weibo_url      = $this->shortcode_atts['weibo_url'];
		$tqq_url       = $this->shortcode_atts['tqq_url'];
		$renren_url        = $this->shortcode_atts['renren_url'];
		$wenxin_url      = $this->shortcode_atts['weixin_url'];
		...
		if ( '' !== $weibo_url ) {
			$social_links .= sprintf(
				'<li><a href="%1$s" class="et_pb_font_icon et_pb_weibo_icon"><span>%2$s</span></a></li>',
				esc_url( $weibo_url ),
				esc_html__( '新浪微博', 'et_builder' )
			);
		}

		if ( '' !== $tqq_url ) {
			$social_links .= sprintf(
				'<li><a href="%1$s" class="et_pb_font_icon et_pb_tqq_icon"><span>%2$s</span></a></li>',
				esc_url( $tqq_url ),
				esc_html__( '腾讯微博', 'et_builder' )
			);
		}

		if ( '' !== $renren_url ) {
			$social_links .= sprintf(
				'<li><a href="%1$s" class="et_pb_font_icon et_pb_renren_icon"><span>%2$s</span></a></li>',
				esc_url( $renren_url ),
				esc_html__( '人人网', 'et_builder' )
			);
		}

		if ( '' !== $weixin_url ) {
			$social_links .= sprintf(
				'<li><a href="%1$s" class="et_pb_font_icon et_pb_weixin_icon"><span>%2$s</span></a></li>',
				esc_url( $weixin_url ),
				esc_html__( '微信', 'et_builder' )
			);
		}
...
class ET_Builder_Module_Blog extends ET_Builder_Module {
	function init() {
		...
		$this->fields_defaults = array(
			...
			'show_more'         => array( 'off' ),
			'posts_limit'      => array( 135, 'add_default_setting' ),
	...
	function get_fields() {
		$fields = array(
			...
			'posts_limit' => array(
				'label'             => __( 'Posts Limit', 'et_builder' ),
				'type'              => 'text',
				'option_category'   => 'configuration',
				'description'       => __( 'Input excerpt words number.', 'et_builder' ),
			),
			'show_author' => array(
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$posts_limit       = $this->shortcode_atts['posts_limit'];
		...
		$fields = array(
			'social_network' => array(
				...
				'options' => array(
			        ...
			        'weibo'    => array(
						'value' => __( '新浪微博', 'et_builder' ),
						'data'  => array( 'color' => '#3b5998' ),
					),
					'tqq'     => array(
						'value' => __( '腾讯微博', 'et_builder' ),
						'data'  => array( 'color' => '#00aced' ),
					),
					'renren' => array(
						'value' => __( '人人网', 'et_builder' ),
						'data'  => array( 'color' => '#dd4b39' ),
					),
					'weixin'   => array(
						'value' => __( '微信', 'et_builder' ),
